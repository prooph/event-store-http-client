...
class read_all_events_backward_should extends TestCase
{
    ...
    protected function when(): void
    {
        ...
        do {
            $slice = $this->conn->readAllEventsBackward($this->endOfEvents, 1, false, DefaultData::adminCredentials());
    ...
    public function return_empty_slice_if_asked_to_read_from_start(): void
    {
        ...
        $this->execute(function () {
            $read = $this->conn->readAllEventsBackward(Position::start(), 1, false, DefaultData::adminCredentials());
    ...
    public function return_events_in_reversed_order_compared_to_written(): void
    {
        ...
        $this->execute(function () {
            $read = $this->conn->readAllEventsBackward($this->endOfEvents, \count($this->testEvents), false, DefaultData::adminCredentials());
            \assert($read instanceof AllEventsSlice);
    ...
    public function be_able_to_read_all_one_by_one_until_end_of_stream(): void
    {
        ...
        $this->execute(function () {
            ...
            while (true) {
                $slice = $this->conn->readAllEventsBackward($position, 1, false, DefaultData::adminCredentials());
                \assert($slice instanceof AllEventsSlice);
    ...
    public function be_able_to_read_events_slice_at_time(): void
    {
        ...
        $this->execute(function () {
            ...
            do {
                $slice = $this->conn->readAllEventsBackward($position, 5, false, DefaultData::adminCredentials());
                \assert($slice instanceof AllEventsSlice);
    ...
    public function throw_when_got_int_max_value_as_maxcount(): void
    {
        $this->execute(function () {
            ...
            $this->conn->readAllEventsBackward(Position::start(), \PHP_INT_MAX, false, DefaultData::adminCredentials());
        });
    }
}
